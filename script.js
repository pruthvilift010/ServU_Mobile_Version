...
async function updateOrder(orderId) {
  const items = [
    { id: "batataParatha", label: "Batata Paratha" },
    { id: "methiParatha", label: "Methi Paratha" },
    { id: "palakParatha", label: "Palak Paratha" },
    { id: "paneerParatha", label: "Paneer Paratha" },
    { id: "methiThalipeeth", label: "Methi Thalipeeth" },
    { id: "gobiParatha", label: "Gobi Paratha" },
    { id: "onionParatha", label: "Onion Paratha" },
    { id: "batatamethiParatha", label: "Batata Methi Paratha" },
    { id: "batatapalakParatha", label: "Batata Palak Paratha" },
    { id: "paneerbutterParatha", label: "Paneer Butter Paratha" },
    { id: "methiThalipeeth", label: "Batata Methi Paratha" },
    { id: "palakThalipeeth", label: "Palak Thalipeeth" },
    { id: "paneerThalipeeth", label: "Paneer Thalipeeth" },
    { id: "corianderThalipeeth", label: "Coriander Thalipeeth" },
    { id: "onionThalipeeth", label: "Onion Thalipeeth" },
    { id: "cucumberThalipeeth", label: "Cucumber Thalipeeth" },
    { id: "beetrootThalipeeth", label: "Beetroot Thalipeeth" },
    { id: "dhudhibhoplaThalipeeth", label: "Dhudhi Bhopla Thalipeeth" },
    { id: "dalwada", label: "Dalwada" },
    { id: "sabudanaKhichdi", label: "Sabudana Khichdi" },
    { id: "dosa", label: "Dosa" },
    { id: "idli", label: "Idli" },
    { id: "upma", label: "Upma" },
    { id: "pohe", label: "Pohe" },
  ...
  items.forEach(item => {
    ...
    if (quantity > 0) {
      ...
      summaryText += `${item.label}: ${quantity}\n`;
    }
  });
